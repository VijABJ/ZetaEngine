...
type
  ...
  TZbScriptCallback = function (lParam1, lParam2: integer): integer; stdcall;
  ...
  private
    ...
    //
    FCreateUIFunc: TZbScriptCallback;
    FHandleEventFunc: TZbScriptCallback;
  ...
  public
    ...
    property CreateUIFunc: TZbScriptCallback read FCreateUIFunc write FCreateUIFunc;
    property HandleEventFunc: TZbScriptCallback read FHandleEventFunc write FHandleEventFunc;
  ...
  function WrapperCreate (cConfigFile: string; UICB, HECB: TZbScriptCallback): TZEWindowsWrapper;
...
begin
  ...
  if (CoreEngine <> NIL) AND (CoreEngine.Refresh) then begin
    FreeAndNIL (CoreEngine);
    PostQuitMessage (0);
  end;
end;
