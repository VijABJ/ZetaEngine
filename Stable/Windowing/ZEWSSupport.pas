...
type
  ...
  protected
    ...
    //
    procedure AddFontNames (FontNames: IZbEnumStringList);
  ...
  public
    ...
    constructor Create (FontNames: IZbEnumStringList); overload; virtual;
    destructor Destroy; override;
    // properties
...
begin
  CommonInit;
  if (AConfigFile <> '') then
    AddFontNames (ConfigManager.LoadSimpleConfig (AConfigFile));
end;

//////////////////////////////////////////////////////////
constructor TZEFontList.Create (FontNames: IZbEnumStringList);
begin
  CommonInit;
...
//////////////////////////////////////////////////////////
procedure TZEFontList.AddFontNames (FontNames: IZbEnumStringList);
var
  cData: String;
begin
