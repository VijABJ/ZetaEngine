...
type
  ...
  private
    ...
    m_Volume: Integer;
  protected
    function GetSoundChannel (AName: string): TZbSoundChannel;
  ...
  public
    ...
    //
    property _Sounds [AName: string]: TZbSoundChannel read GetSoundChannel; default;
...
type
  ...
  function CreateSoundChannelInfo (AFileName: PChar;
    ASoundChannel: TZbSoundChannel): PZbSoundChannelInfo;
  begin
    New (Result);
...
begin
  ...
  while (cParams <> '') do begin
    ...
    if ((cPath <> '') AND (cName <> '')) then begin
      ...
      //
      g_AudioManager.SoundChannelCreate (Channel);
...
//////////////////////////////////////////////////////////////////////////////
function TZESoundEffectsManager.GetSoundChannel (AName: string): TZbSoundChannel;
var
  SCI: PZbSoundChannelInfo;
begin
