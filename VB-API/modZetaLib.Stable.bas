...
Public Const cmEngineTimerTick = cmStandardSystemBase + 28
Public Const cmEngineTimerExpired = cmStandardSystemBase + 29
'// GUI Commands
...
'Declare Sub ZESS_ClearCallbacks Lib "ZetaLib" ()
'Declare Sub ZESS_AddCallback Lib "ZetaLib" (ByVal lpszRefName As String, _
'  ByVal lpfnCallback As Long)
Declare Sub ZESS_TerminateEngine Lib "ZetaLib" ()
