...
begin
  ...
  if (CModalControl = Self) then CModalControl := TZEControl (ModalStack.Pop);
...
////////////////////////////////////////////////////////////////////
procedure TZEControl.DrawCaption;
var
  rArea: TRect;
begin
  if (FShowCaption AND (Font <> NIL)) then begin
...
begin
  Result := NIL;
  if ((FParent <> NIL) AND (FParent.Last <> NIL)) then begin
    WTarget := FNext;
    while true do begin
...
begin
  if (APropertyName = PROP_NAME_WINCLASS_NAME) then
    ...
    //
  end else if (APropertyName = PROP_NAME_SHOW_CAPTION) then
...
begin
  ...
  else if (APropertyName = PROP_NAME_SPRITE_NAME) then begin
    SpriteName := Value;
    //TraceLn ('SpriteName=%s', [SpriteName]);
  end else if (APropertyName = PROP_NAME_FONT_NAME) then begin
...
////////////////////////////////////////////////////////////////////
procedure TZEControl.ClearEvent (var Event: TZbEvent; AZeroOnly: Boolean);
begin
  g_DXFramework.ClearEvent (Event, AZeroOnly);
